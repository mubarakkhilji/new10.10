            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.why-choose-us.create') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Create Why Choose Us</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.why-choose-us.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Why Choose Us List</p>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.client-requirement.index') }}" class="nav-link">
