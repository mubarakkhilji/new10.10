              ...
              <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" id="exampleInputFullName" placeholder="Enter news title">
                        @error('title')
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="details" class="@error('details') is-invalid @enderror">{{ old('details') }}</textarea>
                      @error('details')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
