...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Project Type List</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                <li class="breadcrumb-item active">Project Type List</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <a class="btn btn-sm btn-primary float-right" href="{{ route('admin.type.create') }}">Create New Project Type</a>
                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        @foreach ($types as $key => $type)
                            <tr>
                                <td width="30" class="text-center">{{ $types->firstItem() + $key }}</td>
                                <td>{{ $type->name }}</td>  
                                ...
                                <td width="100" class="text-center">
                                    ...
                                    <button class="btn btn-sm btn-danger" type="button" onclick="deleteType({{ $type->id }})">
